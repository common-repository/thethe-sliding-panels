	...
	<p><strong><q>WordPress Tips, Tricks &amp; Hacks</q></strong></p>
      ...
      <p>
		<form method="post" action="http://em.marketingmixture.com/form.php?form=4" id="frmSS4" onsubmit="return CheckForm4(this);" class="myForm">
          		<input type="text" name="CustomFields[2]" id="CustomFields_2_4" size="8" maxlength="100" value="<?=$current_user->user_firstname.' '.$current_user->user_lastname;?>" />
			<input name="email" value="<?=$current_user->user_email;?>" size="16" maxlength="100" type="text" />	
